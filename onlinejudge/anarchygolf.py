...
from onlinejudge.dispatch import problems
from onlinejudge.dispatch import services
...
class AnarchyGolfService(onlinejudge.service.Service):
    ...
    def from_url(cls, s):
        ...
        if result.scheme in ("", "http", "https") and result.netloc == "golf.shinh.org":
            return cls()
...
services += [AnarchyGolfService]
problems += [AnarchyGolfProblem]
